...
class Realsense(Node):
    ...
    def publish_imgs(self):
        ...
        infra_colormap_1 = cv2.applyColorMap(cv2.convertScaleAbs(self.infra_image_1, alpha=0.03), cv2.COLORMAP_JET)
            
        # Utilisation de colormap sur l'image infrared de la Realsense (image convertie en 8-bit par pixel)
        infra_colormap_2 = cv2.applyColorMap(cv2.convertScaleAbs(self.infra_image_2, alpha=0.03), cv2.COLORMAP_JET)	
