...
class MarkerBouteille(Node):
    ...
    def create_marker_bouteille(self, point_bouteille):
        ...
        bouteille_pose = Pose()
        bouteille_pose.position.x = point_bouteille.z
        bouteille_pose.position.y = point_bouteille.x
        ...
        try:
            ...
            return
        try:
            bouteille_pose = tf2_geometry_msgs.do_transform_pose(bouteille_pose, self.transform_baselink_map)
        except Exception as e:
